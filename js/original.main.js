jQuery(document).ready(function($){
	...
	function checkResize(){
		...
		windowResize = false;
            ...
            var particles = new Particles('.mask img');
            $('.particles-trigger').on('click', function() {
                particles.disintegrate({type: 'triangle'});
								$('.particles-close').css({'display' : 'block'});
								$('.mask span').css({'display' : 'none'});
							});
						$('.particles-close').on('click', function() {
							$('.mask span').css({'display':'block'});
							particles.integrate();
						});
});
